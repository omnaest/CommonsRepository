...
public class ElementRepositoryUtils
{
    ...
    public static <I, D> MapElementRepository<I, D> newJsonHashFileIndexRepository(File directory, int capacity, int numberOfThreads, Class<I> keyType, Class<D> dataType)
    {
